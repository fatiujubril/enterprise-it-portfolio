...
Adobe Acrobat Reader assigned **Required** to `DYN-Users-Finance` — user-targeted, so it follows the user to any device, installed with system rights on behalf of a Standard user (Intune as privilege broker). This assignment is the proof the user track delivers payload, confirmed end to end in the Phase 6 test. Detail and the assignment-type reference: **[app-assignment-matrix.md](./app-assignment-matrix.md)**.
...
[← Back to Phase 4 — Windows Autopilot](../04-autopilot-hybrid-profile/README.md) | [Project overview](../README.md) | [Continue to Phase 6 — Test & Break/Fix →](../06-test-and-breakfix/README.md)
